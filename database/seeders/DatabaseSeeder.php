...
class DatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $staffData = [
            [
                'name' => 'John Doe', 'email' => 'john.doe@example.com', 'password' => bcrypt('password123'),
                'district' => 'Bakori', 'zone' => 'Bakori A', 'phone_number' => '1234567890', 'status' => 'approved',
                'created_at' => now()->setMonth(1)->setYear(2025),
            ],
            [
                'name' => 'Jane Smith', 'email' => 'jane.smith@example.com', 'password' => bcrypt('password123'),
                'district' => 'Batagarawa', 'zone' => 'Barde', 'phone_number' => '1234567891', 'status' => 'pending',
                'created_at' => now()->setMonth(2)->setYear(2025),
            ],
            [
                'name' => 'Aminu Bello', 'email' => 'aminu.bello@example.com', 'password' => bcrypt('password123'),
                'district' => 'Daura', 'zone' => 'Daura Central', 'phone_number' => '1234567892', 'status' => 'approved',
                'created_at' => now()->setMonth(3)->setYear(2025),
            ],
        ];
