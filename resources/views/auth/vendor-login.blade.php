...
<head>
    <base href="../../../" />
    <title>Water Board System - Vendor Login</title>
    <meta charset="utf-8" />
                            ...
                            <div class="card shadow-sm" style="width: 400px;">
                                <div class="card-body p-5">
                                    ...
                                    <div class="text-center mb-4">
                                        <img alt="Logo" src="assets/media/logos/logo.png" class="h-60px mb-3"/>
                                        <h4 class="fw-normal">Vendor Portal</h4>
                                        <p class="text-muted">Water Board Management System</p>
                                    </div>
