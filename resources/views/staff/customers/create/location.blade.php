            ...
            <div class="card">
                <div class="card-header position-relative py-0 border-bottom-2">
                    <div class="card-title">
                        <h2>Create Customer - Location Details</h2>
                    </div>
                ...
                <div class="card-body px-4 px-lg-17">
                    ...
                    <form action="{{ route('staff.customers.store.location') }}" method="POST">
                        @csrf
                        <div class="row mb-6">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="number" step="any" class="form-control form-control-solid @error('latitude') is-invalid @enderror" id="latitude" name="latitude" value="{{ old('latitude', session('customer_creation.location.latitude')) }}" required>
                                @error('latitude')
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="number" step="any" class="form-control form-control-solid @error('longitude') is-invalid @enderror" id="longitude" name="longitude" value="{{ old('longitude', session('customer_creation.location.longitude')) }}" required>
                                @error('longitude')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="number" step="any" class="form-control form-control-solid @error('altitude') is-invalid @enderror" id="altitude" name="altitude" value="{{ old('altitude', session('customer_creation.location.altitude')) }}">
                            ...
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="text" class="form-control form-control-solid @error('pipe_path') is-invalid @enderror" id="pipe_path" name="pipe_path" value="{{ old('pipe_path', session('customer_creation.location.pipe_path')) }}">
                                @error('pipe_path')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-6">
                            <div class="col-md-12 fv-row">
                                ...
                                <textarea class="form-control form-control-solid @error('polygon_coordinates') is-invalid @enderror" id="polygon_coordinates" name="polygon_coordinates" rows="4">{{ old('polygon_coordinates', session('customer_creation.location.polygon_coordinates')) }}</textarea>
                        ...
                        <div class="row mb-6">
                            <div class="col-md-6 fv-row">
                                ...
                                <input type="password" class="form-control form-control-solid @error('password') is-invalid @enderror" id="password" name="password" value="{{ old('password') }}">
                                <small class="form-text text-muted">Leave blank to set default password.</small>
                                @error('password')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
