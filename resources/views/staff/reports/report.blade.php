...
<head>
    <meta charset="UTF-8">
    <title>Combined Billing and Payment Report</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    <div class="container">
        <div class="card">
            ...
            <div class="report-title">Combined Billing and Payment Report</div>
                ...
                <table class="report-table">
                    ...
                    <tbody>
                        @foreach ($payments as $payment)
                            <tr>
                                <td>{{ $payment->customer ? $payment->customer->first_name . ' ' . $payment->customer->surname : 'N/A' }}</td>
