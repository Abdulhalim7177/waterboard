...
<div class="container-xxl flex-lg-row-fluid">
    ...
    <div class="d-flex flex-wrap flex-stack my-5">
        <!--begin::Heading-->
        <h3 class="fw-bold me-5">Zone Details: {{ $zone->name }}</h3>
        <!--end::Heading-->
        <!--begin::Controls-->
        <div class="d-flex flex-wrap my-5 my-md-0">
            <a href="{{ route('staff.zones.index') }}" class="btn btn-light me-2">Back to Zones</a>
        </div>
        <!--end::Controls-->
    </div>
    <!--end::Toolbar-->
    ...
    <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h3 class="card-title">Staff in Zone: {{ count($staffs) }}</h3>
                    </div>
                </div>
                <div class="card-body py-4">
                    ...
                    @else
                        <div class="text-center py-10">
                            <p>No staff assigned to this zone</p>
                        </div>
                    @endif
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card mt-6">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h3 class="card-title">Customers in Zone: {{ count($customers) }}</h3>
                    </div>
                </div>
                <div class="card-body py-4">
