                                ...
                                @forelse($districts as $district)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('staff.districts.destroy', $district->id) }}" class="btn btn-sm btn-light-danger" data-method="delete" data-confirm="Are you sure you want to delete this district?">Delete</a>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
