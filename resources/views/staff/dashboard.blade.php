...
<div class="container-fluid">
    ...
    <!-- Primary Stats Cards Row - Evenly Distributed -->
            ...
            <div class="card shadow-sm border-0 bg-light-info">
                <div class="card-body p-4">
                    <div class="d-flex flex-column align-items-center text-center">
                        ...
                        <span class="text-muted fw-semibold fs-7">Total Tickets</span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Secondary Stats Row - Evenly Distributed -->
    <div class="row g-4 mb-6">
        @can('view-customers', 'staff')
    ...
    <!-- Tertiary Stats Row - Evenly Distributed -->
    <div class="row g-4 mb-6">
    ...
    <!-- Performance Indicators Row - Optimized Layout -->
    ...
    <!-- Quick Actions Section - Organized by Functionality -->
    <div class="card mb-6">
    ...
    <!-- Recent Activities & New Customers Section - Optimized Layout -->
    <div class="row g-4">
