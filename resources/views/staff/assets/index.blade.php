            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-title w-100 d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <input type="text" name="search_assets" id="search_assets" class="form-control form-control-solid w-250px ps-13" placeholder="Search Assets" />
                    </div>
                    ...
                    <div class="d-flex align-items-center gap-2 flex-shrink-0 ms-auto">
                        ...
                        <!--end::Add asset-->
                        <!--begin::Import-->
                        <a href="{{ route('staff.assets.import') }}" class="btn btn-light-primary">Import Assets</a>
                        <!--end::Import-->
                    </div>
                    <!--end::Toolbar-->
                </div>
                    ...
                    <tbody class="fw-semibold text-gray-600">
                        @forelse ($assets as $asset)
                            <tr>
                                ...
                                <td>{{ Str::limit($asset['description'] ?? 'N/A', 50) }}</td>
                                <td>
                                    @if(($asset['type'] ?? 0) == 0)
                                ...
                                <td class="text-end">
                                    ...
                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-150px py-4" data-kt-menu="true">
                                        ...
                                        <!--begin::Menu item-->
                                        <div class="menu-item px-3">
                                            <a href="#" class="menu-link px-3" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $asset['id'] }}">Delete</a>
                                        </div>
                                        <!--end::Menu item-->
                                    </div>
                                    <!--end::Menu-->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Are you sure you want to delete {{ $asset['label'] ?? $asset['ref'] ?? 'Asset' }} ({{ $asset['ref'] ?? 'N/A' }})? This action cannot be undone.
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-light" data-bs-dismiss="modal">Cancel</button>
                                            <form action="{{ route('staff.assets.destroy', $asset['id']) }}" method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="6" class="text-center">
                                    ...
                                    <p class="mb-0">No assets found in the asset management system.</p>
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
        ...
        $(document).ready(function() {
            ...
            $('#search_assets').on('keyup', function() {
                ...
                searchTimeout = setTimeout(function() {
                    ...
                    console.log('Searching for: ' + $('#search_assets').val());
                }, 500);
            });
        });
    </script>
