    ...
    <div class="card">
        ...
        <div class="card-body pt-0">
            ...
            <ul class="nav nav-tabs nav-line-tabs nav-line-tabs-2x mb-5 fs-6">
                <li class="nav-item">
                    <a class="nav-link active" data-bs-toggle="tab" href="#kt_tab_pane_1">Monthly Trends</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_2">Distribution Charts</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-bs-toggle="tab" href="#kt_tab_pane_3">System Components</a>
                </li>
            </ul>
            <!--end::Tabs-->
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <!--begin::Tab pane - System Components-->
                ...
                <!--end::Tab pane - System Components-->
            </div>
            <!--end::Tab content-->
        </div>
        <!--end::Card body-->
